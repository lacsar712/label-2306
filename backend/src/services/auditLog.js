...
const DEFAULT_AUDIT_CONFIGS = [
  ...
  { actionType: 'COUPON_CREATE', sensitivityLevel: 'MEDIUM', description: '优惠券创建' },
  { actionType: 'COUPON_UPDATE', sensitivityLevel: 'MEDIUM', description: '优惠券更新' },
  { actionType: 'COUPON_DELETE', sensitivityLevel: 'HIGH', description: '优惠券删除' },
  { actionType: 'COUPON_STATUS_CHANGE', sensitivityLevel: 'MEDIUM', description: '优惠券状态变更' },
  { actionType: 'COUPON_REDEEM', sensitivityLevel: 'MEDIUM', description: '优惠券核销' },
  { actionType: 'COUPON_REFUND', sensitivityLevel: 'MEDIUM', description: '优惠券退回' },
  ...
  { actionType: 'BIRTHDAY_CONFIG_UPDATE', sensitivityLevel: 'MEDIUM', description: '生日关怀配置更新' },
  { actionType: 'BIRTHDAY_CARE_EXECUTE', sensitivityLevel: 'MEDIUM', description: '生日关怀执行' },
  { actionType: 'BIRTHDAY_CARE_BATCH', sensitivityLevel: 'MEDIUM', description: '生日关怀批量执行' },
  { actionType: 'SHOP_CATEGORY_CREATE', sensitivityLevel: 'MEDIUM', description: '商品分类创建' },
  { actionType: 'SHOP_CATEGORY_UPDATE', sensitivityLevel: 'MEDIUM', description: '商品分类更新' },
  { actionType: 'SHOP_CATEGORY_DELETE', sensitivityLevel: 'MEDIUM', description: '商品分类删除' },
  { actionType: 'SHOP_PRODUCT_CREATE', sensitivityLevel: 'MEDIUM', description: '商品创建' },
  { actionType: 'SHOP_PRODUCT_UPDATE', sensitivityLevel: 'MEDIUM', description: '商品更新' },
  { actionType: 'SHOP_PRODUCT_DELETE', sensitivityLevel: 'MEDIUM', description: '商品删除' },
  { actionType: 'SHOP_PRODUCT_STATUS_CHANGE', sensitivityLevel: 'MEDIUM', description: '商品上下架状态变更' },
  { actionType: 'EXCHANGE_ORDER_CREATE', sensitivityLevel: 'HIGH', description: '兑换单创建' },
  { actionType: 'EXCHANGE_ORDER_STATUS_CHANGE', sensitivityLevel: 'MEDIUM', description: '兑换单状态变更' },
  { actionType: 'EXCHANGE_ORDER_CANCEL', sensitivityLevel: 'HIGH', description: '兑换单取消退款' },
